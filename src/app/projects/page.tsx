...
const projects: ProjectData[] = [
  {
    ...
    description:
      "Research tackling the Reversal Curse — where LLMs learn \"A is B\" but can't infer \"B is A.\" Trained 7B models from scratch on Wikipedia, augmenting passages with diverse QA pairs generated by DeepSeek-R1 to present knowledge from multiple views. Models trained with multi-view augmentation generalize to answer unseen questions, complete un-augmented passages, and handle paraphrased queries — evidence that exposing the same knowledge from different angles builds more robust representations. Inspired by Physics of LLMs (Parts 1-3) and The Reversal Curse.",
    tags: ["LLM Research", "Pre-training", "Reversal Curse", "7B Models"],
  },
  {
