...
*This is Part 4 of [**The Gradient Descent through Transformers**](/blog) — a series where I walk through every component of the modern transformer stack, how it evolved from 2017 to 2026, and why each piece matters.*
...
- **Differential Attention** — the newest (2024-2025) innovation that learns what to attend to and what to ignore
...
*Next in the series: [**Attention Part 2 — The Sharing Lineage**](/blog/attention-architectures) — how MQA, GQA, and MLA solved the KV cache problem by sharing key-value heads across queries.*
