...
*This is Part 1 of [**The Gradient Descent through Transformers**](/blog) — a series where I walk through every component of the modern transformer stack, how it evolved from 2017 to 2026, and why each piece matters.*
...
*Next in the series: [**Positional Encoding Part 1 — Why Transformers Need to Know Where Words Are**](/blog/positional-encoding-absolute) — how transformers know that word order matters, from sinusoidal functions to learned embeddings.*
