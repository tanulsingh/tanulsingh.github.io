...
*This is Part 8 of [**The Gradient Descent through Transformers**](/blog) — a series where I walk through every component of the modern transformer stack, how it evolved from 2017 to 2026, and why each piece matters.*
...
*Next series: [**The Loss Landscape of LLM Training**](/blog/llm-pretraining) — how LLMs go from random weights to aligned intelligence. Pre-training, distributed systems, fine-tuning, RLHF, and reasoning.*
