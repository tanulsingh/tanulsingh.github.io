...
That's the subject of [Part 3: The Sparsity Lineage](/blog/attention-sparsity) — from Sparse Transformer's fixed patterns (2019) to Mistral's sliding window, Gemma 3's hybrid layers, and DeepSeek's learned Native Sparse Attention.
